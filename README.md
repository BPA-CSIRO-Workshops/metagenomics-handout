[![Build Status](https://travis-ci.org/BPA-CSIRO-Workshops/metagenomics-handout.png?branch=master)](https://travis-ci.org/BPA-CSIRO-Workshops/metagenomics-handout)
