[![Build Status](https://travis-ci.org/BioplatformsAustralia/metagenomics-handout.png?branch=master)](https://travis-ci.org/BioplatformsAustralia/metagenomics-handout)
